...
def main():
    ...
    for shot,height in [('chat',1000),('home',1000),('map',900),('logistics',1000),('interaction',1000)]:
        for lang in ['zh','en']:
    ...
    if not errors:print(f'Documentation links, version {version} and 10 PNG captures in 5 language pairs passed.')
    return bool(errors)
